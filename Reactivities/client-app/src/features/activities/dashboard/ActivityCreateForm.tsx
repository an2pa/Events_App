...
export default function ActivityForm({closeForm, selectedActivity, create}: Props) {
    ...
    return (
        ...
        <Form onSubmit={()=>handleSubmit(activity)}>
            ...
            <Button onClick={()=>create(activity)}  type='submit' floated='right' positive content="Submit" />
